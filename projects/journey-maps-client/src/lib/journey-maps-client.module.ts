...
} from './components/marker-details/components/info-block-renderer/components/text-info-block/text-info-block.component';
import {
  ButtonInfoBlockComponent
} from './components/marker-details/components/info-block-renderer/components/button-info-block/button-info-block.component';
...
} from './components/marker-details/components/info-block-renderer/components/address-info-block/address-info-block.component';
